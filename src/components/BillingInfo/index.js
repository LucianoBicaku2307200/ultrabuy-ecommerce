  ...
  return (
    <>
      <div className="flex flex-col items-center w-full">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-8 pt-8 pb-4 w-full justify-around">
          ...
          <div className="flex rounded-lg h-10 ring-1 ring-C1-C bg-C1-F justify-center w-max px-2">
        ...
        {selected ? (
          <div className="flex flex-col items-center w-full border border-C1-D bg-gray-50 rounded-lg px-2">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-8 pb-4 w-full justify-around">
              {inputsCont.map((el, index) => (
                <div key={index} className="flex justify-center">
                  <Input
                    label={el.title}
